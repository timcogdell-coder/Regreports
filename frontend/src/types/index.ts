...
export interface PermitLimit {
  ...
  daily_max_concentration_is_mr: boolean;
  daily_max_loading_is_mr: boolean;
  daily_min_concentration: number | null;
  daily_min_loading: number | null;
  daily_min_concentration_is_mr: boolean;
  daily_min_loading_is_mr: boolean;
  monthly_avg_concentration: number | null;
  monthly_avg_loading: number | null;
  monthly_avg_concentration_is_mr: boolean;
  monthly_avg_loading_is_mr: boolean;
  ...
  weekly_max_concentration_is_mr: boolean;
  weekly_max_loading_is_mr: boolean;
